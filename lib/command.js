...
const command = [
  ...
  {
    name: 'get_daily_primary_menu',
    command: /^\s*!get_daily_primary_menu\r*\n*\s*$/,
    info: 'نمایش منوی اصلی روزانه',
    sample: '!get_daily_primary_menu',
    secure: true,
    show: true,
  },
  {
    name: 'get_daily_secondary_menu',
    command: /^\s*!get_daily_secondary_menu\r*\n*\s*$/,
    info: 'نمایش منوی مخلفات روزانه',
    sample: '!get_daily_secondary_menu',
    secure: true,
    show: true,
  },
  {
  ...
  },
  {
    ...
    sample: '!set_lunch_list_date <date> <lunch1> <lunch2> ...',
    secure: true,
    show: true,
  },
  {
