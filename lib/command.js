...
const command = [
  ...
  },
  {
    ...
    command: /^\s*!get_daily_menu_date\s+([ps])\s+([0-9]{4}-[0-9]{2}-[0-9]{2}|[0-9]{4}.[0-9]{2}.[0-9]{2}|[0-9]{4}\/[0-9]{2}\/[0-9]{2}|[0-9]{8}|[0-9]{2})$/,
  ...
  },
  {
    ...
    command: /^\s*!set_daily_menu_date\s+([ps])\s+([0-9]{4}-[0-9]{2}-[0-9]{2}|[0-9]{4}.[0-9]{2}.[0-9]{2}|[0-9]{4}\/[0-9]{2}\/[0-9]{2}|[0-9]{8}|[0-9]{2}|all)\s(.+)/,
    info: 'افزودن ناهار برای یک تاریخ خاص',
    sample: '!set_daily_menu_date <p|s> <date|all> <lunch1> ...',
    secure: true,
    show: true,
  },
  {
